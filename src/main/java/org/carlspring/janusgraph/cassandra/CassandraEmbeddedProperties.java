...
public class CassandraEmbeddedProperties
{
    ...
    public CassandraEmbeddedProperties(int port)
    {
        ...
        config.read_request_timeout_in_ms = 30000;
        config.range_request_timeout_in_ms = 30000;
        config.write_request_timeout_in_ms = 30000;
        config.cas_contention_timeout_in_ms = 30000;
        config.truncate_request_timeout_in_ms = 30000;
        config.request_timeout_in_ms = 30000;
